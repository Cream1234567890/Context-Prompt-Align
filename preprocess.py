...
train_df_data=pd.read_json("/root/autodl-tmp/BotRGCN/twibot_20/yangweibin/split_ask/new_data/newtrain_split.json")
test_df_data=pd.read_json("/root/autodl-tmp/BotRGCN/twibot_20/yangweibin/split_ask/new_data/newtest_split.json")
df_data=pd.concat([train_df_data,test_df_data],ignore_index=True)
df_data=train_df_data
...
def Des_embbeding_llama():
    ...
    path="/root/autodl-tmp/BotRGCN/twibot_20/fangxx/processed_data/des_tensor_json.pt"
    save_path = "/root/autodl-tmp/BotRGCN/twibot_20/processed_data/temp_yang/des_tensor_json_split_train.pt"
...
def tweets_embedding_llama():
    ...
    path="/root/autodl-tmp/BotRGCN/twibot_20/fangxx/processed_data/tweets_tensor_json.pt"
    save_path = "/root/autodl-tmp/BotRGCN/twibot_20/processed_data/temp_yang/tweets_tensor_json_split_train.pt"
