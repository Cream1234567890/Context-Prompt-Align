...
class BotRGCN(nn.Module):
    def __init__(self,des_size=768,tweet_size=768,num_prop_size=5,middle_dimension=768,cat_prop_size=3,embedding_dimension=128,dropout=0.3):
        super(BotRGCN, self).__init__()
        self.dropout = dropout
        self.linear_relu_des=nn.Sequential(
            # nn.Linear(des_size,int(middle_dimension)),
            # nn.Linear(middle_dimension,int(embedding_dimension/4)),
